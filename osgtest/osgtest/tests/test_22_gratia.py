...
import osgtest.tests.test_20_voms.TestStartVOMS as voms
...
#===============================================================================
    ...
    def test_02_install_http_certs(self):
        ...
        self.skip_ok_if(voms.check_file_and_perms(httpcert, 'tomcat', 0644) and
                        voms.check_file_and_perms(httpkey, 'tomcat', 0400),
                        'HTTP cert exists and has proper permissions')
        voms.install_cert('certs.httpcert', 'certs.hostcert', 'tomcat', 0644)
        voms.install_cert('certs.httpkey', 'certs.hostkey', 'tomcat', 0400)
