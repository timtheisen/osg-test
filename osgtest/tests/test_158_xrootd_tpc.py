...
class TestStartXrootdTPC(osgunittest.OSGTestCase):
    ...
    def test_03_start_xrootd(self):
        ...
        service.check_start(core.config['xrootd_tpc_service_1'], log_to_check = '/var/log/xrootd/third-party-copy-1/xrootd.log', min_up_time = 30)
        service.check_start(core.config['xrootd_tpc_service_2'], log_to_check = '/var/log/xrootd/third-party-copy-2/xrootd.log', min_up_time = 30)
